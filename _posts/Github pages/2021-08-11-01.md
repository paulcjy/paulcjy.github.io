...
excerpt: "Github에 페이지를 만들고 웹 브라우저로 접속해보자."
date: 2021-08-11
...
Github repository에 있는 파일들이 그대로 내 컴퓨터에도 저장되고, `git`을 이용하여 두 곳을 연동한다.
그러기 위해서는 먼저 `git`이 설치되어 있어야 한다.
...
주소는 새로 만든 repository의 주소에 `.git`을 붙인 것이다.
